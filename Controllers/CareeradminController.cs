    ...
    return View("Views/Admin/Career/welcome.cshtml", data);
            ...
            [FromForm] string ExistingImage2)
        {
            ...
            try
            {
                ...
                var welcome = await _context.Set<CareerWelcomeModel>().FirstOrDefaultAsync();
                if (welcome == null)
                {
                    // Create new welcome entry
                    welcome = new CareerWelcomeModel
                    {
                        Mainhead = Mainhead,
                        Subhead = Subhead,
                        Image1 = image1Path,
        ...
        private async Task<string> SaveImageAsync(IFormFile file)
        {
            ...
            var uploads = Path.Combine(_webHostEnvironment.WebRootPath, "uploads/career");
