    ...
    return View("Views/Admin/contact/welcome.cshtml", data);
            ...
            [FromForm] string ExistingImage2)
        {
            ...
            try
            {
                ...
                var welcome = await _context.Set<ContactWelcome>().FirstOrDefaultAsync();
                if (welcome == null)
                {
                    // Create new welcome entry
                    welcome = new ContactWelcome
                    {
                        Mainhead = Mainhead,
                        Subhead = Subhead,
                        Image1 = image1Path,
        ...
        private async Task<string> SaveImageAsync(IFormFile file)
        {
            ...
            var uploads = Path.Combine(_webHostEnvironment.WebRootPath, "uploads/contact");
